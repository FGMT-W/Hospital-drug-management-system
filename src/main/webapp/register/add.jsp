...
<body>
<form action="${path }Register" method="post" class="definewidth m20" enctype="multipart/form-data">
...
<table class="table table-bordered table-hover definewidth m10">
    ...
    <tr>
        <td colspan="2">
			<center>
				<input type="submit" class="btn btn-primary" value="确认保存"></input> &nbsp;&nbsp;<button type="button" class="btn btn-success" name="backid" id="backid">返回列表</button>
			</center>
		</td>
    </tr>
</table>
