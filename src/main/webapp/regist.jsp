...
<body>
<div class="container">	
    <form class="form-signin" method="post" action="User?method=insertUser">
        ...
        <input id="btn" type="button" value="注册" name="btn" class="btn btn-large btn-info" style="width: 100px;"/>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
